...
def load_dataset(type, thing_classes, map_classes):
    ...
    filepath = '/home/group02/week3/data/split/kitti_mots_' + type + '.txt'
...
def parse_args(args=sys.argv[1:]):
    ...
    parser.add_argument('--model', type=str, default='retinanet_R_50_FPN_3x',
...
if __name__ == "__main__":
    ...
    cfg.OUTPUT_DIR = '/home/group02/week3/results/' + args.model + '/lr_' + str(args.lr).replace('.', '_') + '_iter_' + str(args.iter) + '_batch_' + str(args.batch) + '/'
